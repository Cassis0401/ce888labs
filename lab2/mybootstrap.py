...
if __name__ == "__main__":
	...
	data = df.values.T[0]	#getting the values from curren fleet
	boots = []
	...
	data = data[np.logical_not(np.isnan(data))] #remove the nan https://stackoverflow.com/		questions/21011777/how-can-i-remove-nan-from-list-python-numpy
	boots = []
	boots = boostrap(np.std,10000,data)
