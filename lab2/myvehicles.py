...
if __name__ == "__main__":
	...
	ndf = df.dropna()	#the fuction from python to remove the nan
	print (ndf.columns)
	...
	sns_plot.savefig("my_scaterplot.png",bbox_inches='tight')	#save in png
	sns_plot.savefig("my_scaterplot.pdf",bbox_inches='tight')	#save in pdf
	...
	sns_plot2.savefig("my_histogram.png",bbox_inches='tight')
	sns_plot2.savefig("my_histogram.pdf",bbox_inches='tight')
